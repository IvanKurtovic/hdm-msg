...
import de.hdm.gruppe2.shared.CommonSettings;
...
public class ClientsideSettings extends CommonSettings {
	...
	private static MsgServiceAsync msgEditorVerwaltung = null;
	
	//TODO: Report einfügen
	//	private static MsgServiceReportAsync msgReportVerwaltung = null;
	...
	private static final Logger log = Logger.getLogger(LOGGER_NAME);
	 ...
	 /**
	   ...
	   * @since 28.02.2012
	   */
	  public static MsgServiceAsync getMsgEditorVerwaltung() {
	    // Gab es bislang noch keine Sms (Service)-Instanz, dann...
	    if ( msgEditorVerwaltung == null) {
	      // Zunächst instantiieren wir Msg(Service)
	    	msgEditorVerwaltung = GWT.create(MsgService.class);
	    }

	    // So, nun brauchen wir die Sms(Service) nur noch zurückzugeben.
	    return msgEditorVerwaltung;
	  }
	  ...
	  //TODO: Report einfügen
//	  public static MsgServiceAsync getReportGenerator() {
//		    // Gab es bislang noch keine ReportGenerator-Instanz, dann...
//		    if (msgReportVerwaltung == null) {
//		      // Zunächst instantiieren wir ReportGenerator
//		    	msgReportVerwaltung = GWT.create(MsgReportService.class);		     
//		    }
//		    // So, nun brauchen wir den ReportGenerator nur noch zurückzugeben.
//		    return msgReportVerwaltung;
//		  }
}