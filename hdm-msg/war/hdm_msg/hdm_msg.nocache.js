...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "hdm_msg" because\n';
  ...
  $wnd.__gwt_activeModules['hdm_msg'] = {
    'moduleName' : 'hdm_msg',
    'bindings' : function() {
      return {};
    }
 ...
 * "/hdm_msg.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['hdm_msg'].superdevmode = true;

  var expectedSuffix = '/hdm_msg.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + hdm_msg + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:hdm_msg';
  var devModeSessionKey = '__gwtDevModeSession:hdm_msg';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/hdm_msg/hdm_msg.nocache.js';
  ...
  $wnd.__gwt_activeModules['hdm_msg'].canRedirect = true;
  $wnd.__gwt_activeModules['hdm_msg'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/hdm_msg?user.agent=' + ua + '&_callback=' + callback;
