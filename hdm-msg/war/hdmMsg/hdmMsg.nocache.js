...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "hdmMsg" because\n';
  ...
  $wnd.__gwt_activeModules['hdmMsg'] = {
    'moduleName' : 'hdmMsg',
    'bindings' : function() {
      return {};
    }
 ...
 * "/hdmMsg.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['hdmMsg'].superdevmode = true;

  var expectedSuffix = '/hdmMsg.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + hdmMsg + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:hdmMsg';
  var devModeSessionKey = '__gwtDevModeSession:hdmMsg';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/hdmMsg/hdmMsg.nocache.js';
  ...
  $wnd.__gwt_activeModules['hdmMsg'].canRedirect = true;
  $wnd.__gwt_activeModules['hdmMsg'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/hdmMsg?user.agent=' + ua + '&_callback=' + callback;
